  ...
  constructor(
    ...
    public loading: LoadingService) {
        ...
        this.route.params.subscribe(params => {
              ...
              this.id = params['id']; 
             console.log("committe_id :"+this.id);
              this.commonService.getCommitteeMembers(this.id).subscribe((data: any[]) => {           
                
                this.zone.run(() => {  
                    this.listData = data;
                    console.log("GetCommitteeList :"+this.listData[0].committee_name);
